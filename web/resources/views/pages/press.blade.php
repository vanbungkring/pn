        ...
        <div class="row">
            ...
            <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="kode_event_list">
                                ...
                                <a href="{{ url_title('sosok', $more) }}"> {{ $more->title }}</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="kf_pagination">
                    <ul class="pagination">
                        @if($prev)
                        <li class="pull-left"> <a aria-label="Previous" href="{{url_title('sosok',$prev)}}"><b>« Prev News</b></a></li>
                        @endif

                        @if($next) 
                        <li class="pull-right"> <a aria-label="Next" href="{{url_title('sosok',$next) }}"><b> Next News »</b></a></li>
                        @endif
                    </ul>
                </div>
